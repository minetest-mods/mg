...
buildings = {
	...
	{sizex=16, sizez=17, yoff= 0, ysize=12, scm="church", orients={3}, pervillage=1, force_air_level=1},
	...
	{sizex=15, sizez= 7, yoff= 0, ysize=12, scm="inn", orients={1}, force_air_level=1},
	{sizex=22, sizez=17, yoff= 0, ysize= 7, scm="pub", orients={3}, force_air_level=1},
}
